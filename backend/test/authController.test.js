...
describe('authController', () => {
    ...
    describe('login', () => {
        ...
        it('deve fazer login e retornar token', async () => {
            ...
            User.findOne.mockResolvedValue({ id: 1, email: 'existe@teste.com', password: 'hash', role: 'user' });
            bcrypt.compare.mockResolvedValue(true);
            jwt.sign.mockReturnValue('tokenFake123');

            await authController.login(req, res);

            expect(jwt.sign).toHaveBeenCalledWith({ id: 1 }, process.env.JWT_SECRET, expect.any(Object));
